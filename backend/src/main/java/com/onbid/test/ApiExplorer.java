...
public class ApiExplorer {
    public static void main(String[] args) throws IOException {
        String apiKey = System.getenv("ONBID_API_KEY");
        
        if (apiKey == null || apiKey.isEmpty()) {
            System.err.println(" 환경변수 ONBID_API_KEY가 설정되지 않았습니다!");
            return;
        }
        
        System.out.println("✅ API Key 로드 성공: " + apiKey.substring(0, 10) + "...");
