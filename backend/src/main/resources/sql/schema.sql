...
CREATE TABLE goods_basic (
    id INT PRIMARY KEY AUTO_INCREMENT COMMENT '기본 ID',
    history_no INT UNIQUE NOT NULL COMMENT '물건이력번호',
...
CREATE TABLE goods_price (
    id INT PRIMARY KEY AUTO_INCREMENT COMMENT '가격 ID',
    history_no INT NOT NULL UNIQUE COMMENT '물건이력번호',
...
CREATE TABLE purchases (
    id INT PRIMARY KEY AUTO_INCREMENT COMMENT '매매 ID',
    history_no INT NOT NULL COMMENT '물건이력번호',
